...
#    "Classify/AirlineComplaints",
    ...
    # 'SequenceLabeling/dhl_eng_ocr_eng',
    # 'SequenceLabeling/dhl_all_ocr_eng',
    # 'SequenceLabeling/dhl_non_eng_lang_all',
    # 'SequenceLabeling/dhl_all_lang_all',
    'SequenceLabeling/multilingual_ner',
    'SequenceLabeling/ner_de',
    'SequenceLabeling/ner_en',
    'SequenceLabeling/ner_es',
    'SequenceLabeling/ner_fr',
    'SequenceLabeling/ner_it',
    'SequenceLabeling/ner_ja',
    'SequenceLabeling/ner_ko',
    'SequenceLabeling/ner_ru',
    'SequenceLabeling/ner_tr',
    'SequenceLabeling/ner_zh',
