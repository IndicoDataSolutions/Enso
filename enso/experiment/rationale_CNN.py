...
class RationaleCNN:
    ...
    def build_simple_doc_model(self):
        ...
        output = Dense(self.num_classes, activation="softmax", name="doc_prediction")(doc_vector)
    ...
    def build_RA_CNN_model(self):
        ...
        doc_output = Dense(self.num_classes, activation="softmax", name="doc_prediction")(doc_vector)
    ...
    def train_sentence_model(self, train_documents, nb_epoch=100, 
                                downsample=True, 
                                sent_val_split=.2, 
